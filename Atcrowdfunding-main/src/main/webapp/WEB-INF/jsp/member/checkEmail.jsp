      ...
      <div class="page-header">
		...
		<form role="form" style="margin-top:20px;">
		  <div class="form-group">
			...
			<input type="text" class="form-control" id="email" value="${user.email }" placeholder="请输入用于接收验证码的邮箱地址">
		  </div>
          <button type="button" onclick="window.location.href='apply.htm'" class="btn btn-default">上一步</button>
        ...
        $("#nextBtn").click(function(){        	
        	$.ajax({
		   		...
		   		success : function(result) {
		   			...
		   			if ( result.success ) {
		   				layer.msg("发送成功", {time:1500, icon:6});	
