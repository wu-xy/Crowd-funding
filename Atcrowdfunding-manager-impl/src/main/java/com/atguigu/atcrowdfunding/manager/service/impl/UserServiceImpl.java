...
public class UserServiceImpl implements UserService {
	...
	@Override
	public List<Integer> queryRoleIds(int id) {

		return userMapper.queryRoleIds(id);
	}

	@Override
	public int doUnAssignRole(int userid, Data data) {
		
		return userMapper.doUnAssignRole(userid,data);
	}

	@Override
	public int doAssignRole(int userid, Data data) {
		
		return userMapper.doAssignRole(userid,data);
	}
